...
app.include_router(
    create_interactive_router(
        storage=storage,
        resolve_paper_by_id=_resolve_paper_by_id,
        bump_api_cache_epochs=_bump_api_cache_epochs,
        attach_labels=_attach_labels,
        download_pdf=downloader.download_pdf,
        background_retrain=background_retrain,
        BookmarkRequestModel=BookmarkRequest,
        RateRequestModel=RateRequest,
        PinRequestModel=PinRequest,
        WeeklyPickRequestModel=WeeklyPickRequest,
